...
export default function PageHeader({title1, title2, title3, serviceType, price}) {
  return <>
    <div className="ml-4 md:ml-20 pt-32 md:pt-16">
      <h1 className="sm:hidden text-2xl font-light">{title1}</h1>
      <h1 className="hidden sm:block text-4xl font-light">{title2}</h1>
      {title3 && <h1 className="text-base sm:text-2xl font-light mt-3">{title3}</h1>}  
    </div>
