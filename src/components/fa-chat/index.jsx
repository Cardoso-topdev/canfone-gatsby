...
export default function FAChat() {
  return <>
    <div className="md:hidden flex items-end bg-canfone-red py-5">
      <div className="flex-1">
        <h2 className="text-xl md:text-2xl ml-4 mr-6 md:ml-20 text-white font-light">Get Canfone Now.</h2>
        <h2 className="flex-1 text-xl md:text-2xl ml-4 mr-6 md:ml-20 text-white font-bold">Call 1-866-857-3140</h2>
      </div>
    ...
    <div className="hidden md:flex bg-canfone-red py-5">
      <h2 className="flex-1 text-xl md:text-2xl ml-4 mr-6 md:ml-20 text-white font-light">Get Canfone Now. <span className="font-bold">Call 1-866-857-3140</span></h2>
